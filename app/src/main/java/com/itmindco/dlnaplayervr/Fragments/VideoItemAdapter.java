...
import com.itmindco.dlnaplayervr.Fragments.VideoItemFragment.OnListFragmentInteractionListener;
...
public class VideoItemAdapter extends RecyclerView.Adapter<VideoItemAdapter.ViewHolder> {
    ...
    private final List<VideoListItem> mValues;
    private final OnListFragmentInteractionListener mListener;

    public VideoItemAdapter(List<VideoListItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
